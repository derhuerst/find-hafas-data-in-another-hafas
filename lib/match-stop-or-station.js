...
const createMatcher = (srcNameA, normalizeNameA, srcNameB, normalizeNameB) => {
	const matchByStableId = createByStableId(srcNameA, normalizeNameA, srcNameB, normalizeNameB)
	const matchByName = createByName(srcNameA, normalizeNameA, srcNameB, normalizeNameB)
